...
<%--
/*
* fmiVendorTool.jsp    1.1.0  2016-07-24
*  
...
<%
  ...
  FMIVendorTool fmiVendorTool = Domain2OSLCManager.getFMIVendorToolMapByIdentifier(fmuFileName, identifier);
  ...
  String vendortoolURI = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort() + 
    "/oslc4jfmi/services/" + fmuFileName + "/VendorTool/" + identifier;
%>
...
<h4>ResourceLinks</h4> 
  <div class="container">
  <% if (fmiVendorTool != null && fmiVendorTool.getAnnotations() != null) { %>
  <div class="col-md-12"><h4>Annotations</h4>
    <div class="container">
<% for (Link link : fmiVendorTool.getAnnotations()) { %>
...
<h4>Attributes</h4> 
  <div class="container">
  <%  if (fmiVendorTool != null) { %>
  <div class="col-md-12"><b>Identifier</b><br>
  <%= fmiVendorTool.getIdentifier() %>&nbsp;</div><hr>
  <%  } %>
  <%  if (fmiVendorTool != null) { %>
  <div class="col-md-12"><b>Name</b><br>
  <%= fmiVendorTool.getName() %>&nbsp;</div><hr>
  <%  } %>
  </div>
</body>
</html>
