/*
* FMITypeDefService.java    1.1.0  2016-07-23
*  
...
@OslcService(Constants.FMI_TYPEDEF_DOMAIN)
@Path("{fmuFileName}/TypeDef")
public class FMITypeDefService {
  @Context private HttpServletRequest httpServletRequest;
  @Context private HttpServletResponse httpServletResponse;
  @Context private UriInfo uriInfo;
  @OslcQueryCapability(title = "TypeDef Query Capability",
    label = "TypeDef Query Capability",
    resourceShape = OslcConstants.PATH_RESOURCE_SHAPES + "/" + Constants.PATH_FMI_TYPEDEF,
    resourceTypes = { Constants.TYPE_FMI_TYPEDEF}, usages = { OslcConstants.OSLC_USAGE_DEFAULT })
  @GET
  @Produces({ OslcMediaType.APPLICATION_RDF_XML,OslcMediaType.APPLICATION_XML, OslcMediaType.APPLICATION_JSON })
  public List<FMITypeDef> getFMITypeDefList(
    ...
    @QueryParam("oslc.pageSize") final String pageSize)
      ...
      if (identifier != null) {
        ...
        return Domain2OSLCManager.getFMITypeDefMap(fmuFileName);
      }
    }
  ...
  @Path("{identifier}")
  @Produces({ OslcMediaType.APPLICATION_RDF_XML,OslcMediaType.APPLICATION_XML, OslcMediaType.APPLICATION_JSON })
  public FMITypeDef getFMITypeDef(
    @PathParam("fmuFileName") final String fmuFileName,
    @PathParam("identifier") final String identifier) 
      throws Exception {
        return Domain2OSLCManager.getFMITypeDefMapByIdentifier(fmuFileName, identifier);
    }

  @GET
  @Produces(MediaType.TEXT_HTML)
  public void getHtmlFMITypeDefList(
    @PathParam("fmuFileName") final String fmuFileName,
    @QueryParam("identifier") final String identifier,
    @QueryParam("page") final String pageString) {
    try {
      ...
      RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/fmiTypeDefList.jsp");
  ...
  public void getHtmlFMITypeDef(
    ...
    try {
      ...
      httpServletRequest.setAttribute("identifier", identifier);
      httpServletRequest.setAttribute("provider", Domain2OSLCManager.getServiceProvider(fmuFileName));
      RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/fmiTypeDef.jsp");
      rd.forward(httpServletRequest, httpServletResponse);
    } catch (Exception e) {
      e.printStackTrace();
      throw new WebApplicationException(e);
