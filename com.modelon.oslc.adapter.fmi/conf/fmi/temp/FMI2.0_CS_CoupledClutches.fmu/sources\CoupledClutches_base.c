...
static const int N_boolean_pi = 13;
...
static const int N_time_sw = 3;
static const int N_state_sw = 27;
static const int N_sw = 3 + 27;
...
const char *C_GUID = "7211ccd539322707c5523f3eece14e58";
...
const int fmi_runtime_options_map_vrefs[] = {
    536871009, 49, 268435540, 50, 268435541, 51, 536871010, 52, 53, 268435542,
    268435543, 536871011, 54, 268435544, 55, 56, 57, 58, 59, 60,
    536871012, 536871013, 268435545, 536871014, 536871015, 536871016, 536871017, 0
};
...
static int model_init_F1(jmi_t* jmi, jmi_real_t** res) {
    ...
    (*res)[42] = 0.0 - _der_2_J1_phi_163;
    (*res)[43] = 0.0 - _der_2_clutch1_phi_rel_164;
    (*res)[44] = 0.0 - _der_2_J2_phi_165;
    (*res)[45] = 0.0 - _der_2_clutch2_phi_rel_166;
    (*res)[46] = 0.0 - _der_2_J3_phi_167;
    (*res)[47] = 0.0 - _der_2_clutch3_phi_rel_168;
    (*res)[48] = 0.0 - _der_2_J4_phi_169;
