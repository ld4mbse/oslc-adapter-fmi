...
<%--
/*
* fmiDerivative.jsp    1.1.0  2016-07-24
*  
...
<h4>Attributes</h4> 
  ...
  <%= fmiDerivative.getIdentifier() %>&nbsp;</div><hr>
  <%  } %>
  <%  if (fmiDerivative != null) { %>
  <div class="col-md-12"><b>Name</b><br>
  <%= fmiDerivative.getName() %>&nbsp;</div><hr>
  <%  } %>
  <%  if (fmiDerivative != null) { %>
  <div class="col-md-12"><b>Index</b><br>
  <%= fmiDerivative.getIndex() %>&nbsp;</div><hr>
  <%  } %>
  <%  if (fmiDerivative != null) { %>
  <div class="col-md-12"><b>Dependencies</b><br>
  <%= fmiDerivative.getDependencies() %>&nbsp;</div><hr>
  <%  } %>
  <%  if (fmiDerivative != null) { %>
  <div class="col-md-12"><b>DependenciesKind</b><br>
  <%= fmiDerivative.getDependenciesKind() %>&nbsp;</div><hr>
  <%  } %>
  </div>
</body>
</html>
