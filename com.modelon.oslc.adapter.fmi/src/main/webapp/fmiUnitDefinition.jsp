...
<%--
/*
* fmiUnitDefinition.jsp    1.1.0  2016-07-24
*  
...
<%
  ...
  FMIUnitDefinition fmiUnitDefinition = Domain2OSLCManager.getFMIUnitDefinitionMapByIdentifier(fmuFileName, identifier);
  ...
  String unitdefinitionURI = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort() + 
    "/oslc4jfmi/services/" + fmuFileName + "/UnitDefinition/" + identifier;
%>
...
<h4>ResourceLinks</h4> 
  <div class="container">
  <% if (fmiUnitDefinition != null && fmiUnitDefinition.getBaseUnit() != null) { %>
    <div class="col-md-12"><h4>BaseUnit</h4>
    <a href="<%= fmiUnitDefinition.getBaseUnit().toString() %>"><%= fmiUnitDefinition.getBaseUnit().toString() %></a></div>
  <% } %>
  </div>
<h4>Attributes</h4> 
  <div class="container">
  <%  if (fmiUnitDefinition != null) { %>
  <div class="col-md-12"><b>Identifier</b><br>
  <%= fmiUnitDefinition.getIdentifier() %>&nbsp;</div><hr>
  <%  } %>
  <%  if (fmiUnitDefinition != null) { %>
  <div class="col-md-12"><b>Name</b><br>
  <%= fmiUnitDefinition.getName() %>&nbsp;</div><hr>
  <%  } %>
  </div>
</body>
</html>
