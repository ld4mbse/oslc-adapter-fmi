...
<%--
/*
* fmiListingAlias.jsp    1.1.0  2016-07-24
*  
...
<%
  ...
  FMIListingAlias fmiListingAlias = Domain2OSLCManager.getFMIListingAliasMapByIdentifier(fmuFileName, identifier);
  ...
  String listingaliasURI = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort() + 
    "/oslc4jfmi/services/" + fmuFileName + "/ListingAlias/" + identifier;
%>
...
<h4>Attributes</h4> 
  <div class="container">
  <%  if (fmiListingAlias != null) { %>
  <div class="col-md-12"><b>Identifier</b><br>
  <%= fmiListingAlias.getIdentifier() %>&nbsp;</div><hr>
  <%  } %>
  <%  if (fmiListingAlias != null) { %>
  <div class="col-md-12"><b>Name</b><br>
  <%= fmiListingAlias.getName() %>&nbsp;</div><hr>
  <%  } %>
  </div>
</body>
</html>
