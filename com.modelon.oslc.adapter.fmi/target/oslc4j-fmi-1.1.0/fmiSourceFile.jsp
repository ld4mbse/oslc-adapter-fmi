...
<%--
/*
* fmiSourceFile.jsp    1.1.0  2016-07-24
*  
...
<%
  ...
  FMISourceFile fmiSourceFile = Domain2OSLCManager.getFMISourceFileMapByIdentifier(fmuFileName, identifier);
  ...
  String sourcefileURI = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort() + 
    "/oslc4jfmi/services/" + fmuFileName + "/SourceFile/" + identifier;
%>
...
<h4>Attributes</h4> 
  <div class="container">
  <%  if (fmiSourceFile != null) { %>
  <div class="col-md-12"><b>Identifier</b><br>
  <%= fmiSourceFile.getIdentifier() %>&nbsp;</div><hr>
  <%  } %>
  <%  if (fmiSourceFile != null) { %>
  <div class="col-md-12"><b>File</b><br>
  <%= fmiSourceFile.getFile() %>&nbsp;</div><hr>
  <%  } %>
  </div>
</body>
</html>
