/*
* FMIOutputService.java    1.1.0  2016-07-23
*  
...
@OslcService(Constants.FMI_OUTPUT_DOMAIN)
@Path("{fmuFileName}/Output")
public class FMIOutputService {
  @Context private HttpServletRequest httpServletRequest;
  @Context private HttpServletResponse httpServletResponse;
  @Context private UriInfo uriInfo;
  @OslcQueryCapability(title = "Output Query Capability",
    label = "Output Query Capability",
    resourceShape = OslcConstants.PATH_RESOURCE_SHAPES + "/" + Constants.PATH_FMI_OUTPUT,
    resourceTypes = { Constants.TYPE_FMI_OUTPUT}, usages = { OslcConstants.OSLC_USAGE_DEFAULT })
  @GET
  @Produces({ OslcMediaType.APPLICATION_RDF_XML,OslcMediaType.APPLICATION_XML, OslcMediaType.APPLICATION_JSON })
  public List<FMIOutput> getFMIOutputList(
    ...
    @QueryParam("oslc.pageSize") final String pageSize)
      ...
      if (identifier != null) {
        ...
        return Domain2OSLCManager.getFMIOutputMap(fmuFileName);
      }
    }
  ...
  @Path("{identifier}")
  @Produces({ OslcMediaType.APPLICATION_RDF_XML,OslcMediaType.APPLICATION_XML, OslcMediaType.APPLICATION_JSON })
  public FMIOutput getFMIOutput(
    @PathParam("fmuFileName") final String fmuFileName,
    @PathParam("identifier") final String identifier) 
      throws Exception {
        return Domain2OSLCManager.getFMIOutputMapByIdentifier(fmuFileName, identifier);
    }

  @GET
  @Produces(MediaType.TEXT_HTML)
  public void getHtmlFMIOutputList(
    @PathParam("fmuFileName") final String fmuFileName,
    @QueryParam("identifier") final String identifier,
    @QueryParam("page") final String pageString) {
    try {
      ...
      RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/fmiOutputList.jsp");
  ...
  public void getHtmlFMIOutput(
    ...
    try {
      ...
      httpServletRequest.setAttribute("identifier", identifier);
      httpServletRequest.setAttribute("provider", Domain2OSLCManager.getServiceProvider(fmuFileName));
      RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/fmiOutput.jsp");
      rd.forward(httpServletRequest, httpServletResponse);
    } catch (Exception e) {
      e.printStackTrace();
      throw new WebApplicationException(e);
