/*
* TestFMIEnumerationBase.java    1.1.0  2016-07-23
*  
...
public class TestFMIEnumerationBase {
  ...
  protected TestFMIEnumerationBase() throws Exception {
    super();
  }

  private static void verifyFMIEnumeration(final String   mediaType, final FMIEnumeration theFMIEnumeration) {
    System.out.println("verifyFMIEnumeration");
    assertNotNull(theFMIEnumeration);
 
    final URI  aboutURI     = theFMIEnumeration.getAbout();
    final String identifier  = theFMIEnumeration.getIdentifier();
    final String name  = theFMIEnumeration.getName();
    final String value  = theFMIEnumeration.getValue();
    final String description  = theFMIEnumeration.getDescription();

    System.out.println("Enumeration Query Capability : " + aboutURI);
  ...
  protected void testRetrieves(final String mediaType) {
    ...
    for (ServiceProvider serviceProvider : oslcServiceProviderCatalog.getServiceProviders()) {
      ...
      for (final Service service : services) {
        ...
        if (Constants.FMI_ENUMERATION_DOMAIN.equals(String.valueOf(service.getDomain()))) {
          ...
          for (final QueryCapability queryCapability : queryCapabilities) {
            ...
            final FMIEnumeration[] theFMIEnumerationArray = oslcRestClient.getOslcResources(FMIEnumeration[].class);
            
            
            if (theFMIEnumerationArray != null) {
              if (theFMIEnumerationArray.length < 1) {
                System.out.println("    No FMIEnumeration Resources");
              }
              for (final FMIEnumeration theFMIEnumeration : theFMIEnumerationArray) {
                verifyFMIEnumeration(mediaType, theFMIEnumeration);
              }
            } else { 
              System.out.println("    No FMIEnumeration Resources");
            } 
