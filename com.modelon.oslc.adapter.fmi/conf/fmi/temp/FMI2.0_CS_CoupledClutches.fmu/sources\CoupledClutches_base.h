...
#define __block_jacobian_check_tol_179 ((*(jmi->z))[jmi->offs_real_pi+40])
#define __cs_rel_tol_181 ((*(jmi->z))[jmi->offs_real_pi+41])
#define __cs_step_size_183 ((*(jmi->z))[jmi->offs_real_pi+42])
#define __events_default_tol_185 ((*(jmi->z))[jmi->offs_real_pi+43])
#define __events_tol_factor_186 ((*(jmi->z))[jmi->offs_real_pi+44])
#define __nle_solver_default_tol_190 ((*(jmi->z))[jmi->offs_real_pi+45])
#define __nle_solver_max_residual_scaling_factor_192 ((*(jmi->z))[jmi->offs_real_pi+46])
#define __nle_solver_min_residual_scaling_factor_193 ((*(jmi->z))[jmi->offs_real_pi+47])
#define __nle_solver_min_tol_194 ((*(jmi->z))[jmi->offs_real_pi+48])
#define __nle_solver_regularization_tolerance_195 ((*(jmi->z))[jmi->offs_real_pi+49])
#define __nle_solver_step_limit_factor_196 ((*(jmi->z))[jmi->offs_real_pi+50])
#define __nle_solver_tol_factor_197 ((*(jmi->z))[jmi->offs_real_pi+51])
...
#define __block_solver_experimental_mode_180 ((*(jmi->z))[jmi->offs_integer_pi+0])
#define __cs_solver_182 ((*(jmi->z))[jmi->offs_integer_pi+1])
#define __iteration_variable_scaling_187 ((*(jmi->z))[jmi->offs_integer_pi+2])
#define __log_level_188 ((*(jmi->z))[jmi->offs_integer_pi+3])
#define __nle_solver_max_iter_191 ((*(jmi->z))[jmi->offs_integer_pi+4])
#define __residual_equation_scaling_200 ((*(jmi->z))[jmi->offs_integer_pi+5])
...
#define __block_jacobian_check_178 ((*(jmi->z))[jmi->offs_boolean_pi+0])
#define __enforce_bounds_184 ((*(jmi->z))[jmi->offs_boolean_pi+1])
#define __nle_solver_check_jac_cond_189 ((*(jmi->z))[jmi->offs_boolean_pi+2])
#define __rescale_after_singular_jac_198 ((*(jmi->z))[jmi->offs_boolean_pi+3])
#define __rescale_each_step_199 ((*(jmi->z))[jmi->offs_boolean_pi+4])
#define __runtime_log_to_file_201 ((*(jmi->z))[jmi->offs_boolean_pi+5])
#define __use_Brent_in_1d_202 ((*(jmi->z))[jmi->offs_boolean_pi+6])
#define __use_jacobian_equilibration_203 ((*(jmi->z))[jmi->offs_boolean_pi+7])
#define __use_newton_for_brent_204 ((*(jmi->z))[jmi->offs_boolean_pi+8])
#define _torque_useSupport_9 ((*(jmi->z))[jmi->offs_boolean_pi+9])
#define _clutch1_useHeatPort_41 ((*(jmi->z))[jmi->offs_boolean_pi+10])
#define _clutch2_useHeatPort_87 ((*(jmi->z))[jmi->offs_boolean_pi+11])
#define _clutch3_useHeatPort_124 ((*(jmi->z))[jmi->offs_boolean_pi+12])
#define _der_clutch1_phi_rel_170 ((*(jmi->z))[jmi->offs_real_dx+0])
#define _der_clutch1_w_rel_171 ((*(jmi->z))[jmi->offs_real_dx+1])
#define _der_clutch2_phi_rel_172 ((*(jmi->z))[jmi->offs_real_dx+2])
#define _der_clutch2_w_rel_173 ((*(jmi->z))[jmi->offs_real_dx+3])
#define _der_clutch3_phi_rel_174 ((*(jmi->z))[jmi->offs_real_dx+4])
#define _der_clutch3_w_rel_175 ((*(jmi->z))[jmi->offs_real_dx+5])
#define _der_J4_phi_176 ((*(jmi->z))[jmi->offs_real_dx+6])
#define _der_J4_w_177 ((*(jmi->z))[jmi->offs_real_dx+7])
...
#define _der_2_J1_phi_163 ((*(jmi->z))[jmi->offs_real_w+41])
#define _der_2_clutch1_phi_rel_164 ((*(jmi->z))[jmi->offs_real_w+42])
#define _der_2_J2_phi_165 ((*(jmi->z))[jmi->offs_real_w+43])
#define _der_2_clutch2_phi_rel_166 ((*(jmi->z))[jmi->offs_real_w+44])
#define _der_2_J3_phi_167 ((*(jmi->z))[jmi->offs_real_w+45])
#define _der_2_clutch3_phi_rel_168 ((*(jmi->z))[jmi->offs_real_w+46])
#define _der_2_J4_phi_169 ((*(jmi->z))[jmi->offs_real_w+47])
...
#define pre_der_clutch1_phi_rel_170 ((*(jmi->z))[jmi->offs_pre_real_dx+0])
#define pre_der_clutch1_w_rel_171 ((*(jmi->z))[jmi->offs_pre_real_dx+1])
#define pre_der_clutch2_phi_rel_172 ((*(jmi->z))[jmi->offs_pre_real_dx+2])
#define pre_der_clutch2_w_rel_173 ((*(jmi->z))[jmi->offs_pre_real_dx+3])
#define pre_der_clutch3_phi_rel_174 ((*(jmi->z))[jmi->offs_pre_real_dx+4])
#define pre_der_clutch3_w_rel_175 ((*(jmi->z))[jmi->offs_pre_real_dx+5])
#define pre_der_J4_phi_176 ((*(jmi->z))[jmi->offs_pre_real_dx+6])
#define pre_der_J4_w_177 ((*(jmi->z))[jmi->offs_pre_real_dx+7])
...
#define pre_der_2_J1_phi_163 ((*(jmi->z))[jmi->offs_pre_real_w+41])
#define pre_der_2_clutch1_phi_rel_164 ((*(jmi->z))[jmi->offs_pre_real_w+42])
#define pre_der_2_J2_phi_165 ((*(jmi->z))[jmi->offs_pre_real_w+43])
#define pre_der_2_clutch2_phi_rel_166 ((*(jmi->z))[jmi->offs_pre_real_w+44])
#define pre_der_2_J3_phi_167 ((*(jmi->z))[jmi->offs_pre_real_w+45])
#define pre_der_2_clutch3_phi_rel_168 ((*(jmi->z))[jmi->offs_pre_real_w+46])
#define pre_der_2_J4_phi_169 ((*(jmi->z))[jmi->offs_pre_real_w+47])
