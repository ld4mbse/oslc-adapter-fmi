...
<%--
/*
* fmiTypeDefinitionList.jsp    1.1.0  2016-07-24
*  
...
<%
  ...
  List<FMITypeDefinition> fmiTypeDefinitionList = null;
  if (identifier != null) {
    ...
    fmiTypeDefinitionList = obj;
  } else { 
    fmiTypeDefinitionList = Domain2OSLCManager.getFMITypeDefinitionMap(fmuFileName);
  }
  String typedefinitionURI = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort() + 
    "/oslc4jfmi/services/Resource/" + fmuFileName + "/TypeDefinition";
%>
...
<%  if (fmiTypeDefinitionList != null && fmiTypeDefinitionList.size() > 0) { %>
      <% for (FMITypeDefinition fmiTypeDefinition : fmiTypeDefinitionList) { %>
        <div class="col-md-12"><h4>TypeDefinition : <%= Domain2OSLCManager.decodeURL(Domain2OSLCManager.getVariableName(fmiTypeDefinition.getAbout().toString())) %></h4><a href="<%= fmiTypeDefinition.getAbout().toString() %>"><%= fmiTypeDefinition.getAbout().toString() %></a></div>
      <% } %> 
<%  } else { %> 
      <b>No resources</b>
<%  } %>
