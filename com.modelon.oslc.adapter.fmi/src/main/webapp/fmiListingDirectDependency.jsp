...
<%--
/*
* fmiListingDirectDependency.jsp    1.1.0  2016-07-24
*  
...
<%
  ...
  FMIListingDirectDependency fmiListingDirectDependency = Domain2OSLCManager.getFMIListingDirectDependencyMapByIdentifier(fmuFileName, identifier);
  ...
  String listingdirectdependencyURI = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort() + 
    "/oslc4jfmi/services/" + fmuFileName + "/ListingDirectDependency/" + identifier;
%>
...
<h4>Attributes</h4> 
  <div class="container">
  <%  if (fmiListingDirectDependency != null) { %>
  <div class="col-md-12"><b>Identifier</b><br>
  <%= fmiListingDirectDependency.getIdentifier() %>&nbsp;</div><hr>
  <%  } %>
  <%  if (fmiListingDirectDependency != null) { %>
  <div class="col-md-12"><b>Name</b><br>
  <%= fmiListingDirectDependency.getName() %>&nbsp;</div><hr>
  <%  } %>
  </div>
</body>
</html>
