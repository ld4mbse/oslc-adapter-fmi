...
<%--
/*
* fmiInitialUnknown.jsp    1.1.0  2016-07-24
*  
...
<%
  ...
  FMIInitialUnknown fmiInitialUnknown = Domain2OSLCManager.getFMIInitialUnknownMapByIdentifier(fmuFileName, identifier);
  ...
  String initialunknownURI = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort() + 
    "/oslc4jfmi/services/" + fmuFileName + "/InitialUnknown/" + identifier;
%>
...
<h4>Attributes</h4> 
  <div class="container">
  <%  if (fmiInitialUnknown != null) { %>
  <div class="col-md-12"><b>Identifier</b><br>
  <%= fmiInitialUnknown.getIdentifier() %>&nbsp;</div><hr>
  <%  } %>
  <%  if (fmiInitialUnknown != null) { %>
  <div class="col-md-12"><b>Name</b><br>
  <%= fmiInitialUnknown.getName() %>&nbsp;</div><hr>
  <%  } %>
  <%  if (fmiInitialUnknown != null) { %>
  <div class="col-md-12"><b>Index</b><br>
  <%= fmiInitialUnknown.getIndex() %>&nbsp;</div><hr>
  <%  } %>
  <%  if (fmiInitialUnknown != null) { %>
  <div class="col-md-12"><b>Dependencies</b><br>
  <%= fmiInitialUnknown.getDependencies() %>&nbsp;</div><hr>
  <%  } %>
  <%  if (fmiInitialUnknown != null) { %>
  <div class="col-md-12"><b>DependenciesKind</b><br>
  <%= fmiInitialUnknown.getDependenciesKind() %>&nbsp;</div><hr>
  <%  } %>
  </div>
</body>
</html>
