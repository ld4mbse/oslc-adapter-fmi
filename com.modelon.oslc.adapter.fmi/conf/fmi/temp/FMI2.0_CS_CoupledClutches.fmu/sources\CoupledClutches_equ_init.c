...
void model_init_add_blocks(jmi_t** jmi) {
    jmi_dae_init_add_equation_block(*jmi, dae_init_block_0, NULL, 4, 16, 9, 9, 12, 0, JMI_DISCRETE_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 0, "1", -1);
...
int model_ode_initialize(jmi_t* jmi) {
    ...
    _der_clutch3_phi_rel_174 = _der_J4_phi_176 + (- _der_J3_phi_161);
    ...
    _der_clutch2_phi_rel_172 = _der_J3_phi_161 + (- _der_J2_phi_159);
    ...
    _der_clutch1_phi_rel_170 = _der_J2_phi_159 + (- _der_J1_phi_157);
    ...
    _clutch1_w_rel_20 = _der_clutch1_phi_rel_170;
    ...
    _clutch2_w_rel_66 = _der_clutch2_phi_rel_172;
    ...
    _clutch3_w_rel_103 = _der_clutch3_phi_rel_174;
