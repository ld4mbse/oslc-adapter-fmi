...
<%--
/*
* fmiModelVariables.jsp    1.1.0  2016-07-24
*  
...
<%
  ...
  FMIModelVariables fmiModelVariables = Domain2OSLCManager.getFMIModelVariablesMapByIdentifier(fmuFileName, identifier);
  ...
  String modelvariablesURI = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort() + 
    "/oslc4jfmi/services/" + fmuFileName + "/ModelVariables/" + identifier;
%>
...
<h4>ResourceLinks</h4> 
  <div class="container">
  <% if (fmiModelVariables != null && fmiModelVariables.getScalarVariables() != null) { %>
  <div class="col-md-12"><h4>ScalarVariables</h4>
    <div class="container">
<% for (Link link : fmiModelVariables.getScalarVariables()) { %>
...
<h4>Attributes</h4> 
  <div class="container">
  <%  if (fmiModelVariables != null) { %>
  <div class="col-md-12"><b>Identifier</b><br>
  <%= fmiModelVariables.getIdentifier() %>&nbsp;</div><hr>
  <%  } %>
  </div>
</body>
</html>
