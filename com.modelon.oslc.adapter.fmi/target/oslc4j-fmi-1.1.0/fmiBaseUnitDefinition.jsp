...
<%--
/*
* fmiBaseUnitDefinition.jsp    1.1.0  2016-07-24
*  
...
<%
  ...
  FMIBaseUnitDefinition fmiBaseUnitDefinition = Domain2OSLCManager.getFMIBaseUnitDefinitionMapByIdentifier(fmuFileName, identifier);
  ...
  String baseunitdefinitionURI = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort() + 
    "/oslc4jfmi/services/" + fmuFileName + "/BaseUnitDefinition/" + identifier;
%>
...
<h4>Attributes</h4> 
  <div class="container">
  <%  if (fmiBaseUnitDefinition != null) { %>
  <div class="col-md-12"><b>Identifier</b><br>
  <%= fmiBaseUnitDefinition.getIdentifier() %>&nbsp;</div><hr>
  <%  } %>
  <%  if (fmiBaseUnitDefinition != null) { %>
  <div class="col-md-12"><b>DisplayUnit</b><br>
  <%= fmiBaseUnitDefinition.getDisplayUnit() %>&nbsp;</div><hr>
  <%  } %>
  </div>
</body>
</html>
